<template>
  <div class="safety-inspection">
    ...
    >
      <el-form :model="form" :rules="rules" ref="formRef" label-width="100px" class="safety-form">
        <el-form-item label="巡检编号" prop="id" class="form-item">
          <el-input id="safety-id" v-model="form.id" placeholder="请输入巡检编号" :disabled="isEdit" class="form-input" />
        </el-form-item>
        <el-form-item label="巡检人" prop="inspector" class="form-item">
          <el-input id="safety-inspector" v-model="form.inspector" placeholder="请输入巡检人" class="form-input" />
        </el-form-item>
        <el-form-item label="巡检区域" prop="area" class="form-item">
          <el-input id="safety-area" v-model="form.area" placeholder="请输入巡检区域" class="form-input" />
        </el-form-item>
        <el-form-item label="状态" prop="status" class="form-item">
          <el-radio-group id="safety-status" v-model="form.status" class="radio-group">
            <el-radio value="正常" class="radio-item">正常</el-radio>
            <el-radio value="异常" class="radio-item">异常</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="相关设备" prop="equipmentNames" class="form-item">
          <div class="related-items">
            <el-input id="safety-equipment" v-model="form.equipmentNames" placeholder="选择相关设备" readonly class="form-input equipment-input" />
        ...
        <el-form-item label="相关人员" prop="personnelNames" class="form-item">
          <div class="related-items">
            <el-input id="safety-personnel" v-model="form.personnelNames" placeholder="选择相关人员" readonly class="form-input personnel-input" />
    ...
    <el-dialog
      ...
      title="选择相关设备"
      width="600px"
      class="safety-dialog equipment-select-dialog"
      :append-to-body="true"
      :z-index="10100"
    >
      <el-table 
    ...
    <el-dialog
      ...
      title="选择相关人员"
      width="600px"
      class="safety-dialog personnel-select-dialog"
      :append-to-body="true"
      :z-index="10100"
    >
      <el-table 
...
const resetSafetyData = async () => {
  ...
  ElMessageBox.confirm(
    ...
    try {
      ...
      const currentUserName = localStorage.getItem('zhihui_site_username') || '匿名用户'
      await dataService.addLog('info', `${currentUserName} 重置了所有安全巡检数据`)
      
      ElMessage.success('安全巡检数据已成功重置')
    } catch (error) {
      console.error('重置安全巡检数据失败:', error)
...
.personnel-select-dialog {
  z-index: 10100 !important;
}

.equipment-select-dialog .el-overlay,
.personnel-select-dialog .el-overlay {
  z-index: 10100 !important;
}

.safety-dialog .el-dialog {
