  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            title: '日巡检/周排查/月大检三级巡检制度，下发整改通知单',
            files: []
          },
          {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            title: '需复检材料100%监理见证取样封样送检，影像+台账全留存',
            files: []
          },
          {
      ...
      },
      {
        ...
        children: [
          {
            title: '数字化台账，采购-进场-验收-领用-安装全流程追溯',
            files: []
          },
          {
    ...
    children: [
      {
        ...
        children: [
          {
            title: '通病清单+专项方案，针对性解决渗漏/开裂/空鼓等行业痛点',
            files: []
          },
          {
    ...
    children: [
      {
        ...
        children: [
          {
            title: '一构件一码/一户一码追溯二维码，全流程信息扫码可查',
            files: []
          },
          {
