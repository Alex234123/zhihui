      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-width="120px" class="quality-form">
        ...
        <el-form-item label="类型" prop="type" class="form-item">
          <el-radio-group v-model="form.type" class="radio-group">
            <el-radio value="优秀案例" class="radio-item">优秀案例</el-radio>
            <el-radio value="问题记录" class="radio-item">问题记录</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="负责人" prop="person" class="form-item">
          <el-select
            ...
            class="form-input"
            filterable
            @change="handleQualityManagerChange"
          >
            <el-option
        ...
        <el-form-item label="结果" prop="result" class="form-item">
          <el-radio-group v-model="form.result" class="radio-group">
            <el-radio value="优秀" class="radio-item">优秀</el-radio>
            <el-radio value="合格" class="radio-item">合格</el-radio>
            <el-radio value="不合格" class="radio-item">不合格</el-radio>
            <el-radio value="已整改" class="radio-item">已整改</el-radio>
          </el-radio-group>
        </el-form-item>
...
const handleQualityManagerChange = (selectedName) => {
